        ...
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="text-xl">You must create account and log in before use the app</div>
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">Lorem Ipsum</h2>
                                            <p class="mt-4 text-sm/relaxed">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent euismod orci vel erat consequat, ut blandit ex laoreet.
                                            </p>
                                        </div>
                                    </div>
